...
class CodeBuilder {
  ...
  public function getOutput( $selectedFields = array() ) {
	...
	foreach ( $this->getFields() as $field ) {
		$code .= "\n public ".$field->getType()." get".ucfirst($field->getName())."(){\n  ".$this->padCodeLeft("return this.".$field->getName()).";".$this->padCodeLeft(" \n}\n");
		$code .= "\n public void set".ucfirst($field->getName())."(".$field->getType()." ".$field->getName()."){\n  ".$this->padCodeLeft("this.".$field->getName())."=".$field->getName().";".$this->padCodeLeft(" \n}\n");
